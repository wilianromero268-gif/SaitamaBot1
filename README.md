<<<<<<< HEAD
<div align="center">
  <img src="https://readme-typing-svg.demolab.com?font=JetBrains+Mono&weight=800&size=42&pause=2000&color=00FFE0&center=true&vCenter=true&width=600&height=80&lines=Z%CE%9EN-BOT+%F0%9F%A4%96;WhatsApp+Bot+Base;by+AXELDEV09" alt="SAITAMA-BOT"/>
</div>
...
```js
const config = {
  ownerNumber: ['51991579415'], // tu número completo sin el +
}
```
...
Base desarrollada por **SAIDEV145**
